...
var isChoiceEl = document.getElementById("idStreet");
...
var AccountCodeField = document.getElementById("applicationId");
//var AccountCodeField = document.getElementById("applicationId"),
...
function filterOrder(isValue) {
    var values_phase = isValue;
    applicationList.filter(function (data) {
        var phaseFilter = false;
        matchData = new DOMParser().parseFromString(
            data.values().Phase,
            "text/html"
        );
        var phase = matchData.body.firstElementChild.innerHTML;
        if (phase == "All" || values_phase == "All") {
            phaseFilter = true;
        } else {
            phaseFilter = phase == values_phase;
        }
        return phaseFilter;
    });
...
//    searchEnabled: false,
//});
//var phaseVal = new Choices(phaseField, {
//    searchEnabled: false,
//});
...
var table = document.getElementById("propertiesListTable");
// save all tr
var tr = table.getElementsByTagName("tr");
var trlist = table.querySelectorAll(".list tr");

function filterData() {
    var isstreet = document.getElementById("idStreet").value;
    ...
    applicationList.filter(function (data) {
        ...
        //var street = matchData.body.firstElementChild.innerHTML;
        var street = matchData.body.innerHTML;
        var streetFilter = false;
        //var typeFilter = false;
        //var dateFilter = false;
        if (street == "all" || isstreet == "all") {
            streetFilter = true;
        } else {
            streetFilter = street == isstreet;
        }
